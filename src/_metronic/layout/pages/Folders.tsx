...
const Folders = () => {
    ...
    const handleRemoveFolder = (index:any) => {
       const arr= folders.filter(folder =>folder.name !==index);
       setFolders(arr);
                ...
                <div id="kt_app_toolbar" className="app-toolbar py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
                        ...
                        <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                            {/* <!--begin::Title--> */}
                            <h1 className="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">File Manager - Folders</h1>
                            {/* <!--end::Title--> */}
                            {/* <!--begin::Breadcrumb--> */}
                            <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                ...
                                {/* <!--end::Item--> */}
                                {/* <!--begin::Item--> */}
                                <li className="breadcrumb-item text-muted">File Manager</li>
                                {/* <!--end::Item--> */}
                            </ul>
                            {/* <!--end::Breadcrumb--> */}
                        </div>
                        ...
                        <div className="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <div className="m-0">
                                ...
                                {/* <!--end::Menu toggle--> */}
                                {/* <!--begin::Menu 1--> */}
                                <div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_64b0bed891962">
                                    {/* <!--begin::Header--> */}
                                    ...
                                    <div className="px-7 py-5">
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <div>
                                                <select
                                                    ...
                                                    data-dropdown-parent="#kt_menu_64b0bed891962"
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <label className="form-check form-check-sm form-check-custom form-check-solid">
                                                    <input className="form-check-input" type="checkbox" value="2" checked={isChecked} />
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <div className="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                                                <input className="form-check-input" type="checkbox" value="" name="notifications" checked={isChecked} />
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="d-flex flex-column">
                                        ...
                                        <div className="text-muted fw-bold">
                                            ...
                                            <span className="mx-3">|</span>758 items</div>
                                    </div>
                                    {/* <!--end::Title--> */}
                                </div>
                            </div>
                                ...
                                <div className="d-flex overflow-auto h-55px">
                                    <ul className="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-semibold flex-nowrap">
                                        ...
                                        < li className="nav-item" >
                                            <a className="nav-link text-active-primary me-6 active" href="#">Files</a>
                                        </li>
                                        {/* <!--end::Nav item--> */}
                            ...
                            <div className="card-header pt-8">
                                ...
                                <div className="card-toolbar">
                                    ...
                                    <div className="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
                                        {/* <!--begin::Export--> */}
                                        <button onClick={toggleTableRow} type="button" className="btn btn-flex btn-light-primary me-3" id="kt_file_manager_new_folder">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex flex-stack">
                                    ...
                                    <div className="badge badge-lg badge-light-primary">
                                        <div className="d-flex align-items-center flex-wrap">
                                            ...
                                            <a href="#">Home</a>
                                            <i className="ki-duotone ki-right fs-2 text-primary mx-1"></i>Folder</div>
                                    </div>
                                    {/* <!--end::Folder path--> */}
                                    {/* <!--begin::Folder Stats--> */}
                                ...
                                <table id="kt_file_manager_list" data-kt-filemanager-table="folders" className="table align-middle table-row-dashed fs-6 gy-5">
                                    ...
                                    <tbody className="fw-semibold text-gray-600">
                                        {/* Folder information */}
                                        <tr className={isTableRowVisible ? '' : 'd-none'}>
                                            <td></td>
                                            <td id="kt_file_manager_add_folder_form" className="fv-row">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/* Cancel button */}
                                                    <button onClick={toggleTableRow} className="btn btn-icon btn-light-danger" id="kt_file_manager_cancel_folder">
                                                        <span className="indicator-label">
                                                                    ...
                                                                    <div className="card card-flush">
                                                                        <div className="card-body p-5">
                                                                            ...
                                                                            <div className="d-flex flex-column text-start d-none" data-kt-filemanger-table="copy_link_result">
                                                                                ...
                                                                                <div className="text-muted fw-normal mt-2 fs-8 px-3">Read only. <a href="../../demo1/dist/apps/file-manager/settings/.html" className="ms-2">Change permissions</a></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="ms-2">
                                                                ...
                                                                <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                                                    <div className="menu-item px-3">
                                                                        <a href="../../demo1/dist/apps/file-manager/files.html" className="menu-link px-3">View</a>
                                                                    </div>
                                                                    <div className="menu-item px-3">
                                                                    ...
                                                                    <div className="menu-item px-3">
                                                                        <a onClick={() => handleRemoveFolder(folder.name)} className="menu-link text-danger px-3" data-kt-filemanager-table-filter="delete_row">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div className="d-none" data-kt-filemanager-template="rename">
                            <div className="fv-row">
                                <div className="d-flex align-items-center">
                                    ...
                                    <input type="text" id="kt_file_manager_rename_input" name="rename_folder_name" placeholder="Enter ethe new folderhhh name" className="form-control mw-250px me-3" value="" />
