...
export function FileUpload() {
    ...
    const [uploadFile, setFileToUpload] = useState([{
        fileId: generate(),
        name: '',
        file: '',
        folderId: id,
    ...
    const handleSave = async (e) => {
        ...
        //pass form data
        await fetch(`/education/user/create`)
            .then((res) => {
                console.log(res)
                ...
                <div className="card-header pt-8">
                    <div className="card-title">
                        ...
                        <div className="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-filemanager-table-filter="search" className="form-control form-control-solid w-250px ps-15" placeholder="Search Files" />
                        </div>
                        {/* <!--end::Search--> */}
                    </div>
                    {/* <!--begin::Card toolbar--> */}
                                ...
                                <td data-order="account">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <a href="../../demo1/dist/apps/file-manager/files/.html"
                                            className="text-gray-800 text-hover-primary">file_name.jpeg</a>
                                    </div>
                                </td>
                                <td>-</td>
                                <td>-</td>
                        ...
                        <form className="form" action="none" id="kt_modal_upload_form">
                            ...
                            <div className="modal-body pt-10 pb-15 px-lg-17">
                                ...
                                <div className="form-group">
                                    ...
                                    {/* <!--begin::Hint--> */}
                                    <span className="form-text fs-6 text-muted py-2">Max file size is 1MB per file.</span>
                                    {/* <!--end::Hint--> */}
                                    {/* <form onSubmit={handleSave}> */}
                                    {uploadFile.map((uploadIndex) => {
                                        return (
                                            <section key={uploadIndex.fileId}>
                                                <div className=''>
                                                    <input type='file' className='form-control'
                                                        onChange={(e) => {
                                                            const myfile = e.target && e.target.files && e.target.files[0];
                                                            setFileToUpload((upload) => upload.map(x => x.fileId === uploadIndex.fileId ? { ...x, myfile } : x))
                                                        }}
                                                    />
                                                </div>
                                                    ...
                                                    {uploadFile && uploadFile.length > 1 &&
                                                        <div>
                                                            <button type='button' className='btn btn-sm btn-danger me-2'
                                                                onClick={() => {
                                                                    setFileToUpload(upload => upload.filter(x => x.fileId !== uploadIndex.fileId))
                                                                }}
                                                            >X</button>
                                                        </div>}
                                                </div>
